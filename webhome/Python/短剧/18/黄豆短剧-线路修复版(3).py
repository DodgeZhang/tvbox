...
class Spider(BaseSpider):
    def __init__(self):
        # 官方发布页 https://pdxdqlwq.cc/ (2026-08-24) 可用的 APP 线路
        # 默认线路一（国内专线，速度快）；备份线路自动切换
        self.host = "https://yuhterdss.cc"
        self.backup_hosts = [
            "https://nbyuikk.top", "https://reefbloom.icu", "https://yoyoflow.cc",
            "https://riripixel.cc", "https://iriscider.cc", "https://bobacast.icu",
            "https://tamaripple.cc", "https://svlyibwt.cc", "https://hddj01.com",
            "https://hddj22.com", "https://hddj03.com", "https://hddj08.com",
            "https://hddj02.com", "https://hddj09.com",
        ]
    ...
    def _api(self, path, data=None, silent=False):
        ...
        for host in hosts:
            ...
            try:
                ...
                r.raise_for_status()
                resp = self._decode(r.content, rid)
                if resp:
                    return resp
            except Exception:
                continue
